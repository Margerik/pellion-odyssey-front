      ...
      <div className={style.footerContacts}>
        ...
        <div className={style.socialPay}>
          ...
          <div className={style.payments}>
            <Image src="/images/footer/visa.svg" alt="visa logo" width={50} height={50}/>
            <Image src="/images/footer/mastercard.svg" alt="mastercard logo" width={50} height={50}/>
            <Image src="/images/footer/paypal.svg" alt="paypal logo" width={50} height={50}/>
            <Image src="/images/footer/unionpay.svg" alt="unionpay logo" width={50} height={50}/>
          </div>
        </div>
